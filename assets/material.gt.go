...
//#begin-gt _definstlib.gt T:Material
	...
	func newMaterialDef (id string) (me *MaterialDef) {
		me = &MaterialDef {}; me.BaseDef.init(id); me.init(); return
	}
	...
	func (me *MaterialDef) NewInst (id string) (inst *MaterialInst) {
		inst = &MaterialInst { Def: me }; inst.Base.init(id); inst.init(); return
	}
...
func init () {
	syncHandlers = append(syncHandlers, func () { for _, lib := range AllMaterialDefLibs { lib.SyncChanges() } })
}
...
type LibsMaterialDef map[string]*LibMaterialDefs
	...
	func (me LibsMaterialDef) new (id string) (lib *LibMaterialDefs) {
		lib = newLibMaterialDefs(id); return
	}
...
type LibMaterialDefs struct {
	...
	func newLibMaterialDefs (id string) (me *LibMaterialDefs) {
		me = &LibMaterialDefs { M: map[string]*MaterialDef {} }; me.Base.init(id); return
	}
	...
	func (me *LibMaterialDefs) Add (d *MaterialDef) (n *MaterialDef) { if me.M[d.ID] == nil { n, me.M[d.ID] = d, d; me.SetDirty() }; return }
