...
//#begin-gt _definstlib.gt T:VisualScene
	...
	func (me *VisualSceneDef) NewInst (id string) (inst *VisualSceneInst) {
		inst = &VisualSceneInst { Def: me }; inst.Base.init(id); inst.init(); return
	}
...
func init () {
	syncHandlers = append(syncHandlers, func () { for _, lib := range AllVisualSceneDefLibs { lib.SyncChanges() } })
}
...
type LibsVisualSceneDef map[string]*LibVisualSceneDefs
	...
	func (me LibsVisualSceneDef) new (id string) (lib *LibVisualSceneDefs) {
		lib = newLibVisualSceneDefs(id); return
	}
...
type LibVisualSceneDefs struct {
	...
	func newLibVisualSceneDefs (id string) (me *LibVisualSceneDefs) {
		me = &LibVisualSceneDefs { M: map[string]*VisualSceneDef {} }; me.Base.init(id); return
	}
	...
	func (me *LibVisualSceneDefs) Add (d *VisualSceneDef) (n *VisualSceneDef) { if me.M[d.ID] == nil { n, me.M[d.ID] = d, d; me.SetDirty() }; return }
