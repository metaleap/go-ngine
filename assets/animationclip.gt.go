...
//	Returns a GetRefSidResolver that looks up and yields the AnimationClipDef with the specified Id.
func (me *LibAnimationClipDefs) ResolverGetter() GetRefSidResolver {
