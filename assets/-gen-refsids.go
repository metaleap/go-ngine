...
func (me *NodeDef) resolver(string) refSidResolver {
	return me
}
...
func (me *FxEffectDef) resolver(string) refSidResolver {
	return me
}
...
func (me *FxTechniqueCommonPhong) resolveSidPath(path []string, bag *refSidBag) (val interface{}) {
	if me.Emission != nil {
...
func (me *Source) resolver(string) refSidResolver {
	return me
}
