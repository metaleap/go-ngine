...
func init_ListBools(xn *xmlx.Node) (obj *nga.ListBools) {
	obj = new(nga.ListBools)
	has_ID(xn, &obj.HasID)
	has_Name(xn, &obj.HasName)

	load_ListBools(xn, obj)
	return
}
...
func init_ListInts(xn *xmlx.Node) (obj *nga.ListInts) {
	obj = new(nga.ListInts)
	has_ID(xn, &obj.HasID)
	has_Name(xn, &obj.HasName)

	load_ListInts(xn, obj)
	return
}
...
func init_ListStrings(xn *xmlx.Node) (obj *nga.ListStrings) {
	obj = new(nga.ListStrings)
	has_ID(xn, &obj.HasID)
	has_Name(xn, &obj.HasName)

	load_ListStrings(xn, obj)
	return
}
...
func init_ListFloats(xn *xmlx.Node) (obj *nga.ListFloats) {
	obj = new(nga.ListFloats)
	has_ID(xn, &obj.HasID)
	has_Name(xn, &obj.HasName)

	load_ListFloats(xn, obj)
	return
}
