...
func init_RefSid(xn *xmlx.Node) (obj *nga.RefSid) {
	obj = new(nga.RefSid)
...
func init_FxMaterialBinding(xn *xmlx.Node) (obj *nga.FxMaterialBinding) {
	obj = new(nga.FxMaterialBinding)

	load_FxMaterialBinding(xn, obj)
	return
}
...
func init_RefId(xn *xmlx.Node) (obj *nga.RefId) {
	obj = new(nga.RefId)
