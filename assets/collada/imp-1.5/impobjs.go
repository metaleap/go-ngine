...
func obj_KxSceneInstBindJointAxis(xn *xmlx.Node, n string) (obj *nga.KxSceneInstBindJointAxis) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
		obj = init_KxSceneInstBindJointAxis(xn)
	}
	return
}

func objs_KxSceneInstBindJointAxis(xn *xmlx.Node, n string) (objs []*nga.KxSceneInstBindJointAxis) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxSceneInstBindJointAxis, len(xns))
	for i, xn := range xns {
		objs[i] = obj_KxSceneInstBindJointAxis(xn, "")
	}
	return
}
...
func obj_IndexedInputsV(xn *xmlx.Node, n string) (obj *nga.IndexedInputsV) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
		obj = init_IndexedInputsV(xn)
	}
	return
}

func objs_IndexedInputsV(xn *xmlx.Node, n string) (objs []*nga.IndexedInputsV) {
	xns := xcns(xn, n)
	objs = make([]*nga.IndexedInputsV, len(xns))
	for i, xn := range xns {
		objs[i] = obj_IndexedInputsV(xn, "")
	}
	return
}
...
func obj_FxMaterialBinding(xn *xmlx.Node, n string) (obj *nga.FxMaterialBinding) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
		obj = init_FxMaterialBinding(xn)
	}
	return
}

func objs_FxMaterialBinding(xn *xmlx.Node, n string) (objs []*nga.FxMaterialBinding) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxMaterialBinding, len(xns))
	for i, xn := range xns {
		objs[i] = obj_FxMaterialBinding(xn, "")
	}
	return
}
