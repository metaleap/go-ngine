...
func obj_RefId(xn *xmlx.Node, n string) (obj *nga.RefId) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_RefId(xn *xmlx.Node, n string) (objs []*nga.RefId) {
	xns := xcns(xn, n)
	objs = make([]*nga.RefId, len(xns))
	for i, xn := range xns {
		objs[i] = obj_RefId(xn, "")
	}
	return
...
func obj_RefParam(xn *xmlx.Node, n string) (obj *nga.RefParam) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
		obj = init_RefParam(xn)
	}
	return
}

func objs_RefParam(xn *xmlx.Node, n string) (objs []*nga.RefParam) {
	xns := xcns(xn, n)
	objs = make([]*nga.RefParam, len(xns))
	for i, xn := range xns {
		objs[i] = obj_RefParam(xn, "")
	}
	return
}
...
func obj_RefSid(xn *xmlx.Node, n string) (obj *nga.RefSid) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_RefSid(xn *xmlx.Node, n string) (objs []*nga.RefSid) {
	xns := xcns(xn, n)
	objs = make([]*nga.RefSid, len(xns))
	for i, xn := range xns {
		objs[i] = obj_RefSid(xn, "")
	}
	return
}
