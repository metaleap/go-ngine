...
func obj_FxFilterKind(xn *xmlx.Node, n string) (obj *nga.FxFilterKind) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxFilterKind(xn *xmlx.Node, n string) (objs []*nga.FxFilterKind) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxFilterKind, len(xns))
	for i, xn := range xns {
...
func obj_Formula(xn *xmlx.Node, n string) (obj *nga.Formula) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_Formula(xn *xmlx.Node, n string) (objs []*nga.Formula) {
	xns := xcns(xn, n)
	objs = make([]*nga.Formula, len(xns))
	for i, xn := range xns {
...
func obj_FxCreate(xn *xmlx.Node, n string) (obj *nga.FxCreate) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxCreate(xn *xmlx.Node, n string) (objs []*nga.FxCreate) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxCreate, len(xns))
	for i, xn := range xns {
...
func obj_KxMotionAxis(xn *xmlx.Node, n string) (obj *nga.KxMotionAxis) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxMotionAxis(xn *xmlx.Node, n string) (objs []*nga.KxMotionAxis) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxMotionAxis, len(xns))
	for i, xn := range xns {
...
func obj_PxRigidConstraintDefs(xn *xmlx.Node, n string) (obj *nga.PxRigidConstraintDefs) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_PxRigidConstraintDefs(xn *xmlx.Node, n string) (objs []*nga.PxRigidConstraintDefs) {
	xns := xcns(xn, n)
	objs = make([]*nga.PxRigidConstraintDefs, len(xns))
	for i, xn := range xns {
...
func obj_KxEffector(xn *xmlx.Node, n string) (obj *nga.KxEffector) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxEffector(xn *xmlx.Node, n string) (objs []*nga.KxEffector) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxEffector, len(xns))
	for i, xn := range xns {
...
func obj_KxAttachmentKind(xn *xmlx.Node, n string) (obj *nga.KxAttachmentKind) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxAttachmentKind(xn *xmlx.Node, n string) (objs []*nga.KxAttachmentKind) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxAttachmentKind, len(xns))
	for i, xn := range xns {
...
func obj_FxCubeFace(xn *xmlx.Node, n string) (obj *nga.FxCubeFace) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxCubeFace(xn *xmlx.Node, n string) (objs []*nga.FxCubeFace) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxCubeFace, len(xns))
	for i, xn := range xns {
...
func obj_KxFrameTip(xn *xmlx.Node, n string) (obj *nga.KxFrameTip) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxFrameTip(xn *xmlx.Node, n string) (objs []*nga.KxFrameTip) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxFrameTip, len(xns))
	for i, xn := range xns {
...
func obj_ParamOrUint(xn *xmlx.Node, n string) (obj *nga.ParamOrUint) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_ParamOrUint(xn *xmlx.Node, n string) (objs []*nga.ParamOrUint) {
	xns := xcns(xn, n)
	objs = make([]*nga.ParamOrUint, len(xns))
	for i, xn := range xns {
...
func obj_ParamOrSidFloat(xn *xmlx.Node, n string) (obj *nga.ParamOrSidFloat) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_ParamOrSidFloat(xn *xmlx.Node, n string) (objs []*nga.ParamOrSidFloat) {
	xns := xcns(xn, n)
	objs = make([]*nga.ParamOrSidFloat, len(xns))
	for i, xn := range xns {
...
func obj_AnimSamplerBehavior(xn *xmlx.Node, n string) (obj *nga.AnimSamplerBehavior) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_AnimSamplerBehavior(xn *xmlx.Node, n string) (objs []*nga.AnimSamplerBehavior) {
	xns := xcns(xn, n)
	objs = make([]*nga.AnimSamplerBehavior, len(xns))
	for i, xn := range xns {
...
func obj_KxModelBinding(xn *xmlx.Node, n string) (obj *nga.KxModelBinding) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxModelBinding(xn *xmlx.Node, n string) (objs []*nga.KxModelBinding) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxModelBinding, len(xns))
	for i, xn := range xns {
...
func obj_ChildNode(xn *xmlx.Node, n string) (obj *nga.ChildNode) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_ChildNode(xn *xmlx.Node, n string) (objs []*nga.ChildNode) {
	xns := xcns(xn, n)
	objs = make([]*nga.ChildNode, len(xns))
	for i, xn := range xns {
...
func obj_FxSamplerImage(xn *xmlx.Node, n string) (obj *nga.FxSamplerImage) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxSamplerImage(xn *xmlx.Node, n string) (objs []*nga.FxSamplerImage) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxSamplerImage, len(xns))
	for i, xn := range xns {
...
func obj_GeometryPositioning(xn *xmlx.Node, n string) (obj *nga.GeometryPositioning) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_GeometryPositioning(xn *xmlx.Node, n string) (objs []*nga.GeometryPositioning) {
	xns := xcns(xn, n)
	objs = make([]*nga.GeometryPositioning, len(xns))
	for i, xn := range xns {
...
func obj_ParamOrFloat(xn *xmlx.Node, n string) (obj *nga.ParamOrFloat) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_ParamOrFloat(xn *xmlx.Node, n string) (objs []*nga.ParamOrFloat) {
	xns := xcns(xn, n)
	objs = make([]*nga.ParamOrFloat, len(xns))
	for i, xn := range xns {
...
func obj_PxRigidBodyDefs(xn *xmlx.Node, n string) (obj *nga.PxRigidBodyDefs) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_PxRigidBodyDefs(xn *xmlx.Node, n string) (objs []*nga.PxRigidBodyDefs) {
	xns := xcns(xn, n)
	objs = make([]*nga.PxRigidBodyDefs, len(xns))
	for i, xn := range xns {
...
func obj_FxFormatChannels(xn *xmlx.Node, n string) (obj *nga.FxFormatChannels) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxFormatChannels(xn *xmlx.Node, n string) (objs []*nga.FxFormatChannels) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxFormatChannels, len(xns))
	for i, xn := range xns {
...
func obj_SidString(xn *xmlx.Node, n string) (obj *nga.SidString) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_SidString(xn *xmlx.Node, n string) (objs []*nga.SidString) {
	xns := xcns(xn, n)
	objs = make([]*nga.SidString, len(xns))
	for i, xn := range xns {
...
func obj_KxKinematicsSystem(xn *xmlx.Node, n string) (obj *nga.KxKinematicsSystem) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxKinematicsSystem(xn *xmlx.Node, n string) (objs []*nga.KxKinematicsSystem) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxKinematicsSystem, len(xns))
	for i, xn := range xns {
...
func obj_SidBool(xn *xmlx.Node, n string) (obj *nga.SidBool) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_SidBool(xn *xmlx.Node, n string) (objs []*nga.SidBool) {
	xns := xcns(xn, n)
	objs = make([]*nga.SidBool, len(xns))
	for i, xn := range xns {
...
func obj_KxFrameTcp(xn *xmlx.Node, n string) (obj *nga.KxFrameTcp) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxFrameTcp(xn *xmlx.Node, n string) (objs []*nga.KxFrameTcp) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxFrameTcp, len(xns))
	for i, xn := range xns {
...
func obj_MaterialBinding(xn *xmlx.Node, n string) (obj *nga.MaterialBinding) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_MaterialBinding(xn *xmlx.Node, n string) (objs []*nga.MaterialBinding) {
	xns := xcns(xn, n)
	objs = make([]*nga.MaterialBinding, len(xns))
	for i, xn := range xns {
...
func obj_FxSamplerStates(xn *xmlx.Node, n string) (obj *nga.FxSamplerStates) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxSamplerStates(xn *xmlx.Node, n string) (objs []*nga.FxSamplerStates) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxSamplerStates, len(xns))
	for i, xn := range xns {
...
func obj_FxWrapKind(xn *xmlx.Node, n string) (obj *nga.FxWrapKind) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
		obj = init_FxWrapKind(xn)
	}
	return
}

func objs_FxWrapKind(xn *xmlx.Node, n string) (objs []*nga.FxWrapKind) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxWrapKind, len(xns))
	for i, xn := range xns {
		objs[i] = obj_FxWrapKind(xn, "")
	}
	return
}

func obj_ParamOrFloat2(xn *xmlx.Node, n string) (obj *nga.ParamOrFloat2) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_ParamOrFloat2(xn *xmlx.Node, n string) (objs []*nga.ParamOrFloat2) {
	xns := xcns(xn, n)
	objs = make([]*nga.ParamOrFloat2, len(xns))
	for i, xn := range xns {
...
func obj_ParamOrBool(xn *xmlx.Node, n string) (obj *nga.ParamOrBool) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_ParamOrBool(xn *xmlx.Node, n string) (objs []*nga.ParamOrBool) {
	xns := xcns(xn, n)
	objs = make([]*nga.ParamOrBool, len(xns))
	for i, xn := range xns {
...
func obj_KxAxisLimits(xn *xmlx.Node, n string) (obj *nga.KxAxisLimits) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxAxisLimits(xn *xmlx.Node, n string) (objs []*nga.KxAxisLimits) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxAxisLimits, len(xns))
	for i, xn := range xns {
...
func obj_FxVertexInputBinding(xn *xmlx.Node, n string) (obj *nga.FxVertexInputBinding) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxVertexInputBinding(xn *xmlx.Node, n string) (objs []*nga.FxVertexInputBinding) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxVertexInputBinding, len(xns))
	for i, xn := range xns {
...
func obj_ParamOrRefSid(xn *xmlx.Node, n string) (obj *nga.ParamOrRefSid) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_ParamOrRefSid(xn *xmlx.Node, n string) (objs []*nga.ParamOrRefSid) {
	xns := xcns(xn, n)
	objs = make([]*nga.ParamOrRefSid, len(xns))
	for i, xn := range xns {
...
func obj_FxBinding(xn *xmlx.Node, n string) (obj *nga.FxBinding) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxBinding(xn *xmlx.Node, n string) (objs []*nga.FxBinding) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxBinding, len(xns))
	for i, xn := range xns {
...
func obj_SidVec3(xn *xmlx.Node, n string) (obj *nga.SidVec3) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_SidVec3(xn *xmlx.Node, n string) (objs []*nga.SidVec3) {
	xns := xcns(xn, n)
	objs = make([]*nga.SidVec3, len(xns))
	for i, xn := range xns {
...
func obj_FxFormatPrecision(xn *xmlx.Node, n string) (obj *nga.FxFormatPrecision) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxFormatPrecision(xn *xmlx.Node, n string) (objs []*nga.FxFormatPrecision) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxFormatPrecision, len(xns))
	for i, xn := range xns {
...
func obj_FxShaderStage(xn *xmlx.Node, n string) (obj *nga.FxShaderStage) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxShaderStage(xn *xmlx.Node, n string) (objs []*nga.FxShaderStage) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxShaderStage, len(xns))
	for i, xn := range xns {
...
func obj_Document(xn *xmlx.Node, n string) (obj *nga.Document) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_Document(xn *xmlx.Node, n string) (objs []*nga.Document) {
	xns := xcns(xn, n)
	objs = make([]*nga.Document, len(xns))
	for i, xn := range xns {
...
func obj_KxBinding(xn *xmlx.Node, n string) (obj *nga.KxBinding) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxBinding(xn *xmlx.Node, n string) (objs []*nga.KxBinding) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxBinding, len(xns))
	for i, xn := range xns {
...
func obj_TransformKind(xn *xmlx.Node, n string) (obj *nga.TransformKind) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_TransformKind(xn *xmlx.Node, n string) (objs []*nga.TransformKind) {
	xns := xcns(xn, n)
	objs = make([]*nga.TransformKind, len(xns))
	for i, xn := range xns {
...
func obj_KxJointKind(xn *xmlx.Node, n string) (obj *nga.KxJointKind) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxJointKind(xn *xmlx.Node, n string) (objs []*nga.KxJointKind) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxJointKind, len(xns))
	for i, xn := range xns {
...
func obj_ControllerInputs(xn *xmlx.Node, n string) (obj *nga.ControllerInputs) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_ControllerInputs(xn *xmlx.Node, n string) (objs []*nga.ControllerInputs) {
	xns := xcns(xn, n)
	objs = make([]*nga.ControllerInputs, len(xns))
	for i, xn := range xns {
...
func obj_SidFloat(xn *xmlx.Node, n string) (obj *nga.SidFloat) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_SidFloat(xn *xmlx.Node, n string) (objs []*nga.SidFloat) {
	xns := xcns(xn, n)
	objs = make([]*nga.SidFloat, len(xns))
	for i, xn := range xns {
...
func obj_KxFrameOrigin(xn *xmlx.Node, n string) (obj *nga.KxFrameOrigin) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxFrameOrigin(xn *xmlx.Node, n string) (objs []*nga.KxFrameOrigin) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxFrameOrigin, len(xns))
	for i, xn := range xns {
...
func obj_AnimationClipInst(xn *xmlx.Node, n string) (obj *nga.AnimationClipInst) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_AnimationClipInst(xn *xmlx.Node, n string) (objs []*nga.AnimationClipInst) {
	xns := xcns(xn, n)
	objs = make([]*nga.AnimationClipInst, len(xns))
	for i, xn := range xns {
...
func obj_SidFloat3(xn *xmlx.Node, n string) (obj *nga.SidFloat3) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_SidFloat3(xn *xmlx.Node, n string) (objs []*nga.SidFloat3) {
	xns := xcns(xn, n)
	objs = make([]*nga.SidFloat3, len(xns))
	for i, xn := range xns {
...
func obj_FxFormatRange(xn *xmlx.Node, n string) (obj *nga.FxFormatRange) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxFormatRange(xn *xmlx.Node, n string) (objs []*nga.FxFormatRange) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxFormatRange, len(xns))
	for i, xn := range xns {
...
func obj_KxKinematicsAxis(xn *xmlx.Node, n string) (obj *nga.KxKinematicsAxis) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxKinematicsAxis(xn *xmlx.Node, n string) (objs []*nga.KxKinematicsAxis) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxKinematicsAxis, len(xns))
	for i, xn := range xns {
...
func obj_FxColor(xn *xmlx.Node, n string) (obj *nga.FxColor) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxColor(xn *xmlx.Node, n string) (objs []*nga.FxColor) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxColor, len(xns))
	for i, xn := range xns {
...
func obj_KxMotionSystem(xn *xmlx.Node, n string) (obj *nga.KxMotionSystem) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxMotionSystem(xn *xmlx.Node, n string) (objs []*nga.KxMotionSystem) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxMotionSystem, len(xns))
	for i, xn := range xns {
...
func obj_FxSamplerKind(xn *xmlx.Node, n string) (obj *nga.FxSamplerKind) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxSamplerKind(xn *xmlx.Node, n string) (objs []*nga.FxSamplerKind) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxSamplerKind, len(xns))
	for i, xn := range xns {
...
func obj_SourceArray(xn *xmlx.Node, n string) (obj *nga.SourceArray) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_SourceArray(xn *xmlx.Node, n string) (objs []*nga.SourceArray) {
	xns := xcns(xn, n)
	objs = make([]*nga.SourceArray, len(xns))
	for i, xn := range xns {
...
func obj_KxFrameObject(xn *xmlx.Node, n string) (obj *nga.KxFrameObject) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxFrameObject(xn *xmlx.Node, n string) (objs []*nga.KxFrameObject) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxFrameObject, len(xns))
	for i, xn := range xns {
...
func obj_ParamOrInt(xn *xmlx.Node, n string) (obj *nga.ParamOrInt) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_ParamOrInt(xn *xmlx.Node, n string) (objs []*nga.ParamOrInt) {
	xns := xcns(xn, n)
	objs = make([]*nga.ParamOrInt, len(xns))
	for i, xn := range xns {
...
func obj_FxGlslTechniques(xn *xmlx.Node, n string) (obj *nga.FxGlslTechniques) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxGlslTechniques(xn *xmlx.Node, n string) (objs []*nga.FxGlslTechniques) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxGlslTechniques, len(xns))
	for i, xn := range xns {
...
func obj_ParamInsts(xn *xmlx.Node, n string) (obj *nga.ParamInsts) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_ParamInsts(xn *xmlx.Node, n string) (objs []*nga.ParamInsts) {
	xns := xcns(xn, n)
	objs = make([]*nga.ParamInsts, len(xns))
	for i, xn := range xns {
...
func obj_FxTextureOpaque(xn *xmlx.Node, n string) (obj *nga.FxTextureOpaque) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_FxTextureOpaque(xn *xmlx.Node, n string) (objs []*nga.FxTextureOpaque) {
	xns := xcns(xn, n)
	objs = make([]*nga.FxTextureOpaque, len(xns))
	for i, xn := range xns {
...
func obj_KxAxisIndex(xn *xmlx.Node, n string) (obj *nga.KxAxisIndex) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxAxisIndex(xn *xmlx.Node, n string) (objs []*nga.KxAxisIndex) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxAxisIndex, len(xns))
	for i, xn := range xns {
...
func obj_PxMaterial(xn *xmlx.Node, n string) (obj *nga.PxMaterial) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_PxMaterial(xn *xmlx.Node, n string) (objs []*nga.PxMaterial) {
	xns := xcns(xn, n)
	objs = make([]*nga.PxMaterial, len(xns))
	for i, xn := range xns {
...
func obj_KxFrame(xn *xmlx.Node, n string) (obj *nga.KxFrame) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxFrame(xn *xmlx.Node, n string) (objs []*nga.KxFrame) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxFrame, len(xns))
	for i, xn := range xns {
...
func obj_GeometryPrimitiveKind(xn *xmlx.Node, n string) (obj *nga.GeometryPrimitiveKind) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_GeometryPrimitiveKind(xn *xmlx.Node, n string) (objs []*nga.GeometryPrimitiveKind) {
	xns := xcns(xn, n)
	objs = make([]*nga.GeometryPrimitiveKind, len(xns))
	for i, xn := range xns {
...
func obj_GetRefSidResolver(xn *xmlx.Node, n string) (obj *nga.GetRefSidResolver) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
		obj = init_GetRefSidResolver(xn)
	}
	return
}

func objs_GetRefSidResolver(xn *xmlx.Node, n string) (objs []*nga.GetRefSidResolver) {
	xns := xcns(xn, n)
	objs = make([]*nga.GetRefSidResolver, len(xns))
	for i, xn := range xns {
		objs[i] = obj_GetRefSidResolver(xn, "")
	}
	return
}
...
func obj_KxJointAxisBinding(xn *xmlx.Node, n string) (obj *nga.KxJointAxisBinding) {
	if (xn != nil) && (len(n) > 0) {
		xn = xcn(xn, n)
	}
	if xn != nil {
...
func objs_KxJointAxisBinding(xn *xmlx.Node, n string) (objs []*nga.KxJointAxisBinding) {
	xns := xcns(xn, n)
	objs = make([]*nga.KxJointAxisBinding, len(xns))
	for i, xn := range xns {
