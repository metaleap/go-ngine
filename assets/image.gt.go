...
//#begin-gt _definstlib.gt T:Image
	...
	func (me *ImageDef) NewInst (id string) (inst *ImageInst) {
		inst = &ImageInst { Def: me }; inst.Base.init(id); inst.init(); return
	}
...
func init () {
	syncHandlers = append(syncHandlers, func () { for _, lib := range AllImageDefLibs { lib.SyncChanges() } })
}
...
type LibImageDefs struct {
	...
	func newLibImageDefs (id string) (me *LibImageDefs) {
		me = &LibImageDefs { M: map[string]*ImageDef {} }; me.Base.init(id); return
	}
	...
	func (me *LibImageDefs) Add (d *ImageDef) (n *ImageDef) { if me.M[d.ID] == nil { n, me.M[d.ID] = d, d; me.SetDirty() }; return }
