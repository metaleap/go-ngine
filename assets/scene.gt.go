...
func init() {
	syncHandlers = append(syncHandlers, func() {
		for _, lib := range AllSceneDefLibs {
			lib.SyncChanges()
		}
	})
}
...
func newLibSceneDefs(id string) (me *LibSceneDefs) {
	me = &LibSceneDefs{M: map[string]*SceneDef{}}
	me.Base.init(id)
	return
}
...
func (me *LibSceneDefs) Add(d *SceneDef) (n *SceneDef) {
	if me.M[d.ID] == nil {
		n, me.M[d.ID] = d, d
		me.SetDirty()
	}
